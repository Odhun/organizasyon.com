            ...
            {activeTab === 'announcement' && (
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <span className={`absolute top-1 left-1 w-4 h-4 rounded-full bg-white shadow transition-transform ${announcement.enabled ? 'translate-x-5' : 'translate-x-0'}`} />
                  </button>
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <span className={`absolute top-1 left-1 w-4 h-4 rounded-full bg-white shadow transition-transform ${announcement.dismissible ? 'translate-x-5' : 'translate-x-0'}`} />
                  </button>
